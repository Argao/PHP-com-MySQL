...
--
-- Host: localhost
-- Tempo de geração: 15/05/2024 às 06:35
...
--
-- Banco de dados: `db_games`
--
CREATE DATABASE IF NOT EXISTS `db_games` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `db_games`;
...
('admin', 'Gustavo Guanabara Silva Costa', '$2y$10$RilbNkEA8sNIhxMK21H6yeyIQ8qTrjN3Wx7oO6dCAR1m.TtSdnDJK', 'admin'),
('argao', 'João Gabriel', '$2y$10$kTIYrpWdr0111yMl.paKYOzNksQuKDA8kiCccwFiuTTmqFY7uIBBS', 'admin'),
('teste', 'João da Silva', '$2y$10$4aq31Zr3L21CIJ63W35XzuzFiFXnjHOOAaxlNxYo6EzY6T0KUTIgW', 'editor');
