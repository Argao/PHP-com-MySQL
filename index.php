                    ...
                    if ($busca->num_rows == 0){
                        ...
                        while ($reg=$busca->fetch_object()) {
                            ...
                            if(is_admin()){
                                ...
                                <a href='game-edit.php?cod=$reg->cod'><span class='material-symbols-outlined'>edit</span></a> 
                                <a href='game-delete.php?cod=$reg->cod'><span class='material-symbols-outlined'>delete</span></a>";    
                            }elseif(is_editor()){
